	...
	<div id="bgMain">
		...
		<div id="bgRight">
			...
			<div class="bgRightTable">
				...
				<br />
					<a href="background/bg-goodsPriceManager.jsp?goodsId=<%=goods.getGoodsId()%>&nowprice=<%=goods.getNowprice()%>&freeprice=<%=goods.getFreeprice()%>&mark=<%=goods.getMark()%>">修改商品名称</a>
